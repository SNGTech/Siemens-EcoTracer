...
async function updateResources(flow_rates_payload) {
...
async function initBottleCount() {
    let resourcesData = await MachineResouces.find();
...
export { resetModel, updateResources, getResourcesData, getIngredientNames, decrementBottleCount, initBottleCount };